      ...
      <main className="relative z-10 pt-32 px-6 max-w-7xl mx-auto">
        ...
        <section className="mb-32">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }}>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-[#00FF41]/80">
               <div className="p-8 border border-[#00FF41]/30 bg-[#00FF41]/5">
        ...
        <section id="expertise" className="mb-32">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#00FF41]/20 border border-[#00FF41]/20">
              {Object.entries(data.expertise).map(([category, items]: [string, any], i) => (
                 <div key={category} className="p-12 bg-black">
        ...
        <section id="terminal" className="pb-32">
           <div className="p-12 border-2 border-[#FF00FF] bg-black relative">
              <div className="absolute top-0 left-8 -translate-y-1/2 bg-black px-4 text-[#FF00FF] text-xs font-bold uppercase tracking-widest">
                [ Transmission_Channel ]
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 <div>
                   <h2 className="text-5xl font-bold uppercase tracking-tighter mb-4 text-white">Initialize_Contact.</h2>
                   <p className="text-xs opacity-50 mb-8 max-w-sm">Ready for deployment in QA pipelines, functional testing, and security analysis. Secure channels active.</p>
